  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved document as @document" do
        ...
        post :create, {:document => { "department_id" => "invalid value" }}, valid_session
        assigns(:document).should be_a_new(Document)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested document" do
        ...
        Document.any_instance.should_receive(:update).with({ "department_id" => "1" })
        put :update, {:id => document.to_param, :document => { "department_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the document as @document" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Document.any_instance.stub(:save).and_return(false)
        put :update, {:id => document.to_param, :document => { "department_id" => "invalid value" }}, valid_session
        assigns(:document).should eq(document)
      end
