  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved term as @term" do
        ...
        post :create, {:term => { "name" => "invalid value" }}, valid_session
        assigns(:term).should be_a_new(Term)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested term" do
        ...
        Term.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => term.to_param, :term => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the term as @term" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Term.any_instance.stub(:save).and_return(false)
        put :update, {:id => term.to_param, :term => { "name" => "invalid value" }}, valid_session
        assigns(:term).should eq(term)
      end
