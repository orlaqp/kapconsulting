class InternsController < ApplicationController
  ...
  # GET /interns.json
  def index
    @interns = Intern.includes(:department).includes(:term).all
  end
  ...
  private
    ...
    def intern_params
      params.require(:intern).permit(:department_id, :term_id, :position_title, :first_name, :last_name, :phone_number, :time_zone_id, :personal_email, :school_email)
    end
end
